      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              From our humble beginnings to where we are today, here's a look at our journey.
            </p>
          </div>
            ...
            <div className="space-y-12">
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 rounded-full bg-primary transform -translate-x-1/2 mt-1"></div>
                  <h3 className="text-xl font-bold">2015</h3>
                  <h4 className="text-primary font-medium mb-2">Company Founded</h4>
                  <p className="text-muted-foreground">
                    WeCreate was founded with a vision to help brands tell their stories through compelling visual
                    content.
                  </p>
                </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8 md:order-1 md:col-start-2">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 rounded-full bg-primary transform -translate-x-1/2 mt-1"></div>
                  <h3 className="text-xl font-bold">2017</h3>
                  <h4 className="text-primary font-medium mb-2">Expanded Services</h4>
                  <p className="text-muted-foreground">
                    Added social media marketing to our service offerings to provide comprehensive solutions for our
                    clients.
                  </p>
                </div>
                <div className="md:order-0"></div>
              </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8">
                  ...
                  <h4 className="text-primary font-medium mb-2">New Studio</h4>
                  <p className="text-muted-foreground">
                    Moved to a larger studio space to accommodate our growing team and expanding client base.
                  </p>
                </div>
                <div className="md:pl-8"></div>
              </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8 md:order-1 md:col-start-2">
                  ...
                  <p className="text-muted-foreground">
                    Received multiple industry awards for our creative work and client satisfaction.
                  </p>
                </div>
                <div className="md:order-0"></div>
              </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8">
                  ...
                  <h4 className="text-primary font-medium mb-2">International Expansion</h4>
                  <p className="text-muted-foreground">
                    Expanded our services to international clients, working with brands across the globe.
                  </p>
                </div>
                <div className="md:pl-8"></div>
              </div>
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="md:text-right md:pr-8 md:order-1 md:col-start-2">
                  ...
                  <h4 className="text-primary font-medium mb-2">Continuing to Grow</h4>
                  <p className="text-muted-foreground">
                    Continuing to innovate and grow, helping more brands tell their stories through compelling visual
                    content.
                  </p>
                </div>
                <div className="md:order-0"></div>
